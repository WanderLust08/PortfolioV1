...
const Contact = () => {
  return (
    <div className='flex justify-center my-5 h-full sm:h-[70h] items-center' id="contact">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <form action="" method="post" className="p-6 flex flex-col justify-center max-w-[700px]">
                    <div className="flex flex-col">
                        <input type="name" name="name" id="name" placeholder='Fullname' className="w-100 mt-2 py-3 px-3 rounded-lg bg-gray-800 border border-gray-700 text-white" />
                    </div>
